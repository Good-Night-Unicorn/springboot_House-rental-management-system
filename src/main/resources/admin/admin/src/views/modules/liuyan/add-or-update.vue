    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="投诉建议标题" prop="liuyanName">
                       <el-input v-model="ruleForm.liuyanName"
                                 placeholder="投诉建议标题" clearable  :readonly="ro.liuyanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="投诉建议标题" prop="liuyanName">
                           <el-input v-model="ruleForm.liuyanName"
                                     placeholder="投诉建议标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="投诉建议内容" prop="liuyanText">
                        <el-input type="textarea"  :readonly="ro.liuyanText" v-model="ruleForm.liuyanText" placeholder="投诉建议内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.liuyanText" label="投诉建议内容" prop="liuyanText">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   liuyanName: [
                              { required: true, message: '投诉建议标题不能为空', trigger: 'blur' },
                          ],
                   liuyanText: [
                              { required: true, message: '投诉建议内容不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
                              { required: true, message: '投诉建议时间不能为空', trigger: 'blur' },
                          ],
                   replyText: [
