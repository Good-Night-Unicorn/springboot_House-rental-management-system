      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '报修标题' : ''">
            <el-input prefix-icon="el-icon-search" v-model="searchForm.baoxiuAddress" placeholder="报修标题"
                      clearable></el-input>
          </el-form-item>
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            ...
            <a style="text-decoration:none" class="el-button el-button--success"
               ...
               href="http://localhost:8080/fangwuzulinguanlixitong/upload/baoxiuMuBan.xls"
            >批量导入报修数据模板</a>
            &nbsp;
            <el-upload
                v-if="isAuth('baoxiu','导入导出')"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (this.searchForm.baoxiuAddress != '' && this.searchForm.baoxiuAddress != undefined) {
        params['baoxiuAddress'] = '%' + this.searchForm.baoxiuAddress + '%'
      }
