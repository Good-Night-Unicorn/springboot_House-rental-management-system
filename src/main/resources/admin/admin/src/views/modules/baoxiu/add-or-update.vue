    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修标题" prop="baoxiuAddress">
                       <el-input v-model="ruleForm.baoxiuAddress"
                                 placeholder="报修标题" clearable  :readonly="ro.baoxiuAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报修标题" prop="baoxiuAddress">
                           <el-input v-model="ruleForm.baoxiuAddress"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修位置" prop="baoxiuName">
                       <el-input v-model="ruleForm.baoxiuName"
                                 placeholder="报修位置" clearable  :readonly="ro.baoxiuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报修位置" prop="baoxiuName">
                           <el-input v-model="ruleForm.baoxiuName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报修内容" prop="baoxiuContent">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修费用" prop="baoxiuMoney">
                       <el-input v-model="ruleForm.baoxiuMoney"
                                 placeholder="报修费用" clearable  :readonly="ro.baoxiuMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报修费用" prop="baoxiuMoney">
                           <el-input v-model="ruleForm.baoxiuMoney"
                                     placeholder="报修费用" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   baoxiuMoney: [
                              { required: true, message: '报修费用不能为空', trigger: 'blur' },
