...
var centerMenu = [
    ...
    ,{
        name: '租房评价',
        url: '../fangyuanCommentback/list.html'
    }
    ,{
        name: '房源租赁',
        url: '../fangyuanOrder/list.html'
    }
    ,{
        name: '租房预约',
        url: '../fangyuanYuyue/list.html'
    }
    ,{
        name: '租房合同',
        url: '../zufanghetong/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/fangwuzulinguanlixitong/admin/dist/index.html#/login";
