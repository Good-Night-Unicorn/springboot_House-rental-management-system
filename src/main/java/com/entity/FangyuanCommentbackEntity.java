...
public class FangyuanCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public FangyuanCommentbackEntity() {

	}

	public FangyuanCommentbackEntity(T t) {
		try {
     ...
     * 租房
     */
    @ColumnInfo(comment="租房",type="int(11)")
    ...
    public String toString() {
        return "FangyuanCommentback{" +
            ", id=" + id +
            ", fangyuanId=" + fangyuanId +
            ", yonghuId=" + yonghuId +
            ", fangyuanCommentbackText=" + fangyuanCommentbackText +
