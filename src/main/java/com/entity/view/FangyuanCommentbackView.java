...
public class FangyuanCommentbackView extends FangyuanCommentbackEntity implements Serializable {
	...
	public FangyuanCommentbackView() {

	}

	public FangyuanCommentbackView(FangyuanCommentbackEntity fangyuanCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, fangyuanCommentbackEntity);
	...
	public String toString() {
		return "FangyuanCommentbackView{" +
