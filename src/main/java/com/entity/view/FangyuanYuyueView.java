...
public class FangyuanYuyueView extends FangyuanYuyueEntity implements Serializable {
	...
	*/
	...
	private String fangyuanYuyueYesnoValue;
	...
	public FangyuanYuyueView() {

	}

	public FangyuanYuyueView(FangyuanYuyueEntity fangyuanYuyueEntity) {
		try {
			BeanUtils.copyProperties(this, fangyuanYuyueEntity);
	...
	* 获取： 报名状态的值
	*/
	public String getFangyuanYuyueYesnoValue() {
		return fangyuanYuyueYesnoValue;
	}
	/**
	* 设置： 报名状态的值
	*/
	public void setFangyuanYuyueYesnoValue(String fangyuanYuyueYesnoValue) {
		this.fangyuanYuyueYesnoValue = fangyuanYuyueYesnoValue;
	}
	...
	public String toString() {
		return "FangyuanYuyueView{" +
			", fangyuanYuyueYesnoValue=" + fangyuanYuyueYesnoValue +
